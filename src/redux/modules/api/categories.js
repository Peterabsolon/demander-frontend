...
const GET_LIST_FAIL = 'api/categories/GET_LIST_FAIL'

const GET_BY_ID = 'api/categories/GET_BY_ID'
const GET_BY_ID_SUCCESS = 'api/categories/GET_BY_ID_SUCCESS'
const GET_BY_ID_FAIL = 'api/categories/GET_BY_ID_FAIL'

const SET_FILTER = 'api/categories/SET_FILTER'
const SET_PARAMS = 'api/categories/SET_PARAMS'

const SUBMIT = 'api/categories/SUBMIT'
const SUBMIT_SUCCESS = 'api/categories/SUBMIT_SUCCESS'
const SUBMIT_FAIL = 'api/categories/SUBMIT_FAIL'

const SUBMIT_DELETE = 'api/categories/SUBMIT_DELETE'
const SUBMIT_DELETE_SUCCESS = 'api/categories/SUBMIT_DELETE_SUCCESS'
const SUBMIT_DELETE_FAIL = 'api/categories/SUBMIT_DELETE_FAIL'
...
export const getList = (state, { noLoading } = {}) => {
  const url = `api/categories${routeParams(state, '')}`
...
export const updateEntity = (id, data) => ({
  types: [SUBMIT, SUBMIT_SUCCESS, SUBMIT_FAIL],
  promise: client => client.put(`api/categories/${id}`, { data })
})

export const deleteEntity = id => ({
  types: [SUBMIT_DELETE, SUBMIT_DELETE_SUCCESS, SUBMIT_DELETE_FAIL],
  promise: client => client.del(`api/categories/${id}`)
})
